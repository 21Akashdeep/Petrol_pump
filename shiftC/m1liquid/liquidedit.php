...
$sql = "SELECT * FROM liquidc1 WHERE id = $id";
...
<body>
    <div class="contai-box">
        ...
        <form action="liquidupdate.php" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-3">
                    <input type="text" class="form-control" name="product1" value="<?php echo $row['product1']; ?>"
                        readonly>
                </div>
                <div class="col-2">
                    <input type="text" class="form-control" name="product2" value="<?php echo $row['product2']; ?>"
                        readonly>
                </div>
                <div class="col-2">
                    <input type="text" class="form-control" name="product3" value="<?php echo $row['product3']; ?>"
                        readonly>
                </div>
                <div class="col-3">
                    <input type="text" class="form-control" name="product4" value="<?php echo $row['product4']; ?>"
                        readonly>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-3">
                    <select class="form-select" name="employee1">
                        ...
                        <?php foreach ($employees as $employee) { ?>
                            <option value="<?php echo $employee['company_name']; ?>" <?php echo ($row['employee1'] == $employee['company_name']) ? "selected" : ""; ?>>
                ...
                <div class="col-2">
                    <select class="form-select" name="employee2">
                        <option value="">Select Employee</option>
                        <?php foreach ($employees as $employee) { ?>
                            <option value="<?php echo $employee['company_name']; ?>" <?php echo ($row['employee2'] == $employee['company_name']) ? "selected" : ""; ?>>
                                <?php echo $employee['company_name']; ?>
                            </option>
                        <?php } ?>
                    </select>
                ...
                <div class="col-2">
                    <select class="form-select" name="employee3">
                        <option value="">Select Employee</option>
                        <?php foreach ($employees as $employee) { ?>
                            <option value="<?php echo $employee['company_name']; ?>" <?php echo ($row['employee3'] == $employee['company_name']) ? "selected" : ""; ?>>
                                <?php echo $employee['company_name']; ?>
                            </option>
                        <?php } ?>
                    </select>
                ...
                <div class="col-3">
                    <select class="form-select" name="employee4">
                        <option value="">Select Employee</option>
                        <?php foreach ($employees as $employee) { ?>
                            <option value="<?php echo $employee['company_name']; ?>" <?php echo ($row['employee4'] == $employee['company_name']) ? "selected" : ""; ?>>
                                <?php echo $employee['company_name']; ?>
                            </option>
                        <?php } ?>
                    </select>
    ...
    <script>
        function calculateValues(prefix) {
            ...
            if (document.getElementsByName(prefix + "reading_difference")[0])
                document.getElementsByName(prefix + "reading_difference")[0].value = readingDifference.toFixed(2);
