...
$sql = "
    SELECT ID, Date_And_Time, Employee_Name1 AS Employee_Name, Collection_Name1 AS Collection_Name, Amount1 AS Amount FROM collectionc2
    UNION 
    SELECT ID, Date_And_Time, Employee_Name2 AS Employee_Name, Collection_Name2 AS Collection_Name, Amount2 AS Amount FROM collectionc2
...
// Fetch Vendors Data
$sql = "SELECT * FROM collectionc2 LIMIT $limit OFFSET $offset";
$result = $conn->query($sql);

$sql2 = "SELECT * FROM collectionc2 LIMIT $limit OFFSET $offset";
$result2 = $conn->query($sql2);

// Total Records Count
$sql_count = "SELECT COUNT(*) AS total FROM collectionc2";
