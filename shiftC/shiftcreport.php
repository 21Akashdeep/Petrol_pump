...
$sql3 = "SELECT * FROM shiftc3 WHERE xp_close_reading IS NOT NULL ORDER BY shifta1_datetime DESC LIMIT 1";
...
$sqlliquid = "SELECT * FROM liquidc1 ORDER BY id DESC LIMIT 1";
$resultliquid = $conn->query($sqlliquid);
$dataliquid = $resultliquid->fetch_assoc();

$sqlliquid = "SELECT * FROM liquidc2 ORDER BY id DESC LIMIT 1";
$resultliquid = $conn->query($sqlliquid);
$dataliquida2 = $resultliquid->fetch_assoc();

$sqlliquid = "SELECT * FROM liquidc3 ORDER BY id DESC LIMIT 1";
$resultliquid = $conn->query($sqlliquid);
$dataliquida3 = $resultliquid->fetch_assoc();

$sqlliquid = "SELECT * FROM liquidc4 ORDER BY id DESC LIMIT 1";
$resultliquid = $conn->query($sqlliquid);
$dataliquida4 = $resultliquid->fetch_assoc();

$sqlbank = "SELECT * FROM bankc1 ORDER BY id DESC LIMIT 1";
$resultbank = $conn->query($sqlbank);
$databank = $resultbank->fetch_assoc();

$sqlbanka1 = "SELECT * FROM bankc2 ORDER BY id DESC LIMIT 1";
$resultbanka1 = $conn->query($sqlbanka1);
$databanka1 = $resultbanka1->fetch_assoc();

$sqlbanka2a = "SELECT * FROM bankc3 ORDER BY id DESC LIMIT 1";
$resultbanka2a = $conn->query($sqlbanka2a);
$databanka2a = $resultbanka2a->fetch_assoc();

$sqlbank500 = "SELECT * FROM bankc4 ORDER BY id DESC LIMIT 1";
...
$sqlbanka2 = "SELECT pieces, amount FROM second_shiftc1 WHERE denomination = 200 ORDER BY date_time DESC LIMIT 1";
$resultbanka2 = $conn->query($sqlbanka2);
$databanka2 = $resultbanka2->fetch_assoc();

$sqlbanka2a2 = "SELECT pieces, amount FROM second_shiftc2 WHERE denomination = 200 ORDER BY date_time DESC LIMIT 1";
$resultbanka2a2 = $conn->query($sqlbanka2a2);
$databanka2a2 = $resultbanka2a2->fetch_assoc();

$sqlbanka2a3 = "SELECT pieces, amount FROM second_shiftc3 WHERE denomination = 200 ORDER BY date_time DESC LIMIT 1";
$resultbanka2a3 = $conn->query($sqlbanka2a3);
$databanka2a3 = $resultbanka2a3->fetch_assoc();

$sqlbanka2a4 = "SELECT pieces, amount FROM second_shiftc4 WHERE denomination = 200 ORDER BY date_time DESC LIMIT 1";
$resultbanka2a4 = $conn->query($sqlbanka2a4);
$databanka2a4 = $resultbanka2a4->fetch_assoc();

$sqlbanka3 = "SELECT pieces, amount FROM second_shiftc1 WHERE denomination = 100 ORDER BY date_time DESC LIMIT 1";
$resultbanka3 = $conn->query($sqlbanka3);
$databanka3 = $resultbanka3->fetch_assoc();

$sqlbanka3a2 = "SELECT pieces, amount FROM second_shiftc2 WHERE denomination = 100 ORDER BY date_time DESC LIMIT 1";
$resultbanka3a2 = $conn->query($sqlbanka3a2);
$databanka3a2 = $resultbanka3a2->fetch_assoc();

$sqlbanka3a3 = "SELECT pieces, amount FROM second_shiftc3 WHERE denomination = 100 ORDER BY date_time DESC LIMIT 1";
$resultbanka3a3 = $conn->query($sqlbanka3a3);
$databanka3a3 = $resultbanka3a3->fetch_assoc();

$sqlbanka3a4 = "SELECT pieces, amount FROM second_shiftc4 WHERE denomination = 100 ORDER BY date_time DESC LIMIT 1";
$resultbanka3a4 = $conn->query($sqlbanka3a4);
$databanka3a4 = $resultbanka3a4->fetch_assoc();

$sqlbanka4 = "SELECT pieces, amount FROM second_shiftc1 WHERE denomination = 50 ORDER BY date_time DESC LIMIT 1";
$resultbanka4 = $conn->query($sqlbanka4);
$databanka4 = $resultbanka4->fetch_assoc();

$sqlbanka4a2 = "SELECT pieces, amount FROM second_shiftc2 WHERE denomination = 50 ORDER BY date_time DESC LIMIT 1";
$resultbanka4a2 = $conn->query($sqlbanka4a2);
$databanka4a2 = $resultbanka4a2->fetch_assoc();

$sqlbanka4a3 = "SELECT pieces, amount FROM second_shiftc3 WHERE denomination = 50 ORDER BY date_time DESC LIMIT 1";
$resultbanka4a3 = $conn->query($sqlbanka4a3);
$databanka4a3 = $resultbanka4a3->fetch_assoc();

$sqlbanka4a4 = "SELECT pieces, amount FROM second_shiftc4 WHERE denomination = 50 ORDER BY date_time DESC LIMIT 1";
$resultbanka4a4 = $conn->query($sqlbanka4a4);
$databanka4a4 = $resultbanka4a4->fetch_assoc();

$sqlbanka5 = "SELECT pieces, amount FROM second_shiftc1 WHERE denomination = 20 ORDER BY date_time DESC LIMIT 1";
$resultbanka5 = $conn->query($sqlbanka5);
$databanka5 = $resultbanka5->fetch_assoc();

$sqlbanka5a2 = "SELECT pieces, amount FROM second_shiftc2 WHERE denomination = 20 ORDER BY date_time DESC LIMIT 1";
$resultbanka5a2 = $conn->query($sqlbanka5a2);
$databanka5a2 = $resultbanka5a2->fetch_assoc();

$sqlbanka5a3 = "SELECT pieces, amount FROM second_shiftc3 WHERE denomination = 20 ORDER BY date_time DESC LIMIT 1";
...
$sqlbanka5a4 = "SELECT pieces, amount FROM second_shiftc4 WHERE denomination = 20 ORDER BY date_time DESC LIMIT 1";
$resultbanka5a4 = $conn->query($sqlbanka5a4);
$databanka5a4 = $resultbanka5a4->fetch_assoc();

$sqlbanka6 = "SELECT pieces, amount FROM second_shiftc1 WHERE denomination = 10 ORDER BY date_time DESC LIMIT 1";
$resultbanka6 = $conn->query($sqlbanka6);
$databanka6 = $resultbanka6->fetch_assoc();

$sqlbanka6a2 = "SELECT pieces, amount FROM second_shiftc2 WHERE denomination = 10 ORDER BY date_time DESC LIMIT 1";
$resultbanka6a2 = $conn->query($sqlbanka6a2);
$databanka6a2 = $resultbanka6a2->fetch_assoc();

$sqlbanka6a3 = "SELECT pieces, amount FROM second_shiftc3 WHERE denomination = 10 ORDER BY date_time DESC LIMIT 1";
$resultbanka6a3 = $conn->query($sqlbanka6a3);
$databanka6a3 = $resultbanka6a3->fetch_assoc();

$sqlbanka6a4 = "SELECT pieces, amount FROM second_shiftc4 WHERE denomination = 10 ORDER BY date_time DESC LIMIT 1";
$resultbanka6a4 = $conn->query($sqlbanka6a4);
$databanka6a4 = $resultbanka6a4->fetch_assoc();

$sqlbanka7 = "SELECT pieces, amount FROM second_shiftc1 WHERE denomination = 'Coins' ORDER BY date_time DESC LIMIT 1";
$resultbanka7 = $conn->query($sqlbanka7);
$databanka7 = $resultbanka7->fetch_assoc();

$sqlbanka7a2 = "SELECT pieces, amount FROM second_shiftc2 WHERE denomination = 'Coins' ORDER BY date_time DESC LIMIT 1";
$resultbanka7a2 = $conn->query($sqlbanka7a2);
$databanka7a2 = $resultbanka7a2->fetch_assoc();

$sqlbanka7a3 = "SELECT pieces, amount FROM second_shiftc3 WHERE denomination = 'Coins' ORDER BY date_time DESC LIMIT 1";
$resultbanka7a3 = $conn->query($sqlbanka7a3);
$databanka7a3 = $resultbanka7a3->fetch_assoc();

$sqlbanka7a4 = "SELECT pieces, amount FROM second_shiftc4 WHERE denomination = 'Coins' ORDER BY date_time DESC LIMIT 1";
