...
<body>
    ...
    <div class="row mt-3">
        <div class="col-12 text-center">
            ...
            <div>
                        <button type="button" class="btn btn-success mt-2"onclick="window.location.href='advancemoney.php';">Advance</button>
                    </div>
        </div>
    </div>
    ...
    function resetForm() {
        ...
        document.querySelectorAll('input:not([name="xp_start_reading"]):not([name="ms_start_reading"]), select')
            .forEach(field => {
