...
displayTable($conn, "bankc2", ["id", "denomination", "pieces", "amount", "date_time"], ["ID", "Denomination", "Pieces", "Amount", "Date & Time"], $limit, $offset, $page);
displayTable($conn, "second_shiftc2", ["id", "denomination", "pieces", "amount", "date_time"], ["ID", "Denomination", "Pieces", "Amount", "Date & Time"], $limit, $offset, $page);
displayTable($conn, "transactionsc2", ["id", "total_amount", "date_time"], ["ID", "Total Amount", "Date & Time"], $limit, $offset, $page);
