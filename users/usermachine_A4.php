...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO shiftA4 (current_date_time, closingmeter, employee_name, readingdiff, shift, testing, product, net_sale, nozzle, rate, openingmeter, cash, paytm, card,totalamount) 
...
// Step 1: shiftC1 table se latest closing meter value lena
$sql = "SELECT closingmeter FROM shiftC4 ORDER BY id DESC LIMIT 1";
...
$updateQuery = "UPDATE shiftA4 SET openingmeter = ? ORDER BY id DESC LIMIT 1";
  ...
  <?php include 'navbar.php'; ?>
    ...
    <div class="container mt-5">
      <div class="form-container">
        <div class="form-header">MACHINE A4. REPORT LOGGER</div>
          ...
          <div class="row mt-4">
            ...
            <!-- <button
              ...
              <!-- <button
                type="button"
                class="btn btn-reset"
                onclick="window.location.href='../list/machineA4_list.php'"
              >
                Show Report
              </button> -->
            </div>
