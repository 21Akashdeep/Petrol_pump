...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO shiftA3 (current_date_time, closingmeter, employee_name, readingdiff, shift, testing, product, net_sale, nozzle, rate, openingmeter, cash, paytm, card,totalamount) 
...
$sql = "SELECT closingmeter FROM shiftC3 ORDER BY id DESC LIMIT 1";
...
$updateQuery = "UPDATE shiftA3 SET openingmeter = ? ORDER BY id DESC LIMIT 1";
  ...
  <?php include 'navbar.php'; ?>
    ...
    <div class="container mt-5">
      <div class="form-container">
        <div class="form-header">MACHINE A3. REPORT LOGGER</div>
          ...
          <div class="row mt-4">
            ...
            <!-- <button
              ...
              <!-- <button
                type="button"
                class="btn btn-reset"
                onclick="window.location.href='../list/machineA3_list.php'"
              >
                Show Report
              </button> -->
            </div>
