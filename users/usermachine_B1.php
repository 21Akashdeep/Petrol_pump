...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO shiftB1 (current_date_time, closingmeter, employee_name, readingdiff, shift, testing, product, net_sale, nozzle, rate, openingmeter, cash, paytm, card,totalamount) 
...
$sql = "SELECT closingmeter FROM shift ORDER BY id DESC LIMIT 1";
...
$updateQuery = "UPDATE shiftB1 SET openingmeter = ? ORDER BY id DESC LIMIT 1";
          ...
          <div class="row mt-4">
            ...
            <!-- <button
              ...
              <!-- <button
                type="button"
                class="btn btn-reset"
                onclick="window.location.href='../list/machineB1_list.php'"
              >
                Show Report
              </button> -->
            </div>
