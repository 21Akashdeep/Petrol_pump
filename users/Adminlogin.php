...
if(isset($_POST["submit1"]))
{
    ...
    $res =mysqli_query($link, "select *from signupadmin where username='$_POST[t1]' && password='$_POST[t2]'");
    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-6 col-md-4" style="background-color: aliceblue;margin-Top:15%;">
                ...
                <form method="post">
                <h4 style="display:flex;justify-content: center;">Admin Log In</h4>
                <div class="mb-3">
                ...
                <button type="button" class="btn btn-primary">Admin Sign up</button></a> -->
                <a href="employeesignup.php">
                <button type="button" class="btn btn-primary">Employee Sign up</button></a>
                    <!-- <button>login</button> -->
                </form>
