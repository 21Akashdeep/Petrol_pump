...
$sql_shiftC = "SELECT xp_close_reading FROM shiftc2 ORDER BY id DESC LIMIT 1";
...
$sql_shiftC = "SELECT ms_close_reading FROM shiftc2 ORDER BY id DESC LIMIT 1";
$result_shiftC = $conn->query($sql_shiftC);
$shiftC_data = $result_shiftC->fetch_assoc();
...
$sql_shiftA = "SELECT * FROM shifta2 ORDER BY id DESC LIMIT 1";
...
?>
    ...
    <div class="row">
        <div class="col-3">
            <a href="moneycash/m2moneyreport.php" class="">Add cash</a>
        </div>
        <div class="col-3">
