...
foreach ($fields as $field) {
    $data["xp_".$field] = !empty($_POST["xp_".$field]) ? (is_array($_POST["xp_".$field]) ? implode(",", $_POST["xp_".$field]) : $_POST["xp_".$field]) : '0';
    $data["ms_".$field] = !empty($_POST["ms_".$field]) ? (is_array($_POST["ms_".$field]) ? implode(",", $_POST["ms_".$field]) : $_POST["ms_".$field]) : '0';
}

// Insert Query
$sql = "INSERT INTO shift (shifta1_datetime, shifta1_product1, shifta1_product2, shifta1_emp1, shifta1_emp2, shifta1_nozzle1, shifta1_nozzle2, 
...
$stmt->bind_param("sssssssssssssssssssssssssssssssssss", 
    ...
    $data['xp_paytmM1'], $data['ms_paytmM2'],$data['xp_paytm_amount'],$data['ms_paytm_amount'], $data['xp_cardM1'], $data['ms_cardM2'], $data['xp_card_amount'],$data['ms_card_amount'],
     $data['xp_sortage'], $data['ms_sortage'],
