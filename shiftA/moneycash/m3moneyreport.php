...
displayTable($conn, "banka3", ["id", "denomination", "pieces", "amount", "date_time"], ["ID", "Denomination", "Pieces", "Amount", "Date & Time"], $limit, $offset, $page);
displayTable($conn, "second_shifta3", ["id", "denomination", "pieces", "amount", "date_time"], ["ID", "Denomination", "Pieces", "Amount", "Date & Time"], $limit, $offset, $page);
displayTable($conn, "transactionsa3", ["id", "total_amount", "date_time"], ["ID", "Total Amount", "Date & Time"], $limit, $offset, $page);
