...
echo '<button type="button" class="btn btn-success mb-3" onclick="window.location.href=\'m2moneycash.php\'">Add New Liquid</button>';
echo '&nbsp;&nbsp;';
...
displayTable($conn, "banka2", ["id", "denomination", "pieces", "amount", "date_time"], ["ID", "Denomination", "Pieces", "Amount", "Date & Time"], $limit, $offset, $page);
displayTable($conn, "second_shifta2", ["id", "denomination", "pieces", "amount", "date_time"], ["ID", "Denomination", "Pieces", "Amount", "Date & Time"], $limit, $offset, $page);
displayTable($conn, "transactionsa2", ["id", "total_amount", "date_time"], ["ID", "Total Amount", "Date & Time"], $limit, $offset, $page);
