...
<div class="container mt-4">
    <form action="addmoneym3db.php" method="POST">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-2">
                    ...
                    <script>
                        ...
                        denominations.forEach(value => {
                            document.write(`
                                ...
                                <div class="col-4">
                                    <input type="number" class="form-control qty" name="qty-${value}" id="qty-${value}" data-value="${value}" value="0" min="0">
                                </div>
                                <div class="col-4">
                    ...
                    <div class="col-4"><input type="text" class="form-control" name="coins" id="coins" value="0.00"></div>
                    <div class="col-4"></div>

                    <div class="col-4 fw-bold">Total</div>
                    <div class="col-4"></div>
                    <div class="col-4"><input type="text" class="form-control" name="grand_total" id="grand-total" value="0.00" readonly></div>
