...
$closingc = isset($_SESSION['closingc']) ? $_SESSION['closingc'] : 0;
    ...
    $totala = $bank200result + $bank100result + $bank50result + $bank20result + $bank10result + $coinsresult;
    // $_SESSION = $totala;
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $bank500 = 
                            $databank['pieces']+$databanka1['pieces']+$databanka2['pieces']+$databanka3['pieces'] ;
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $bank200 = $databanka2['pieces']+$databanka2a2['pieces']+$databanka2a3['pieces']+$databanka2a4['pieces'];
                        echo $bank200;
                    ?>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $bank100 = 
                        $databanka3['pieces']+$databanka3a2['pieces']+$databanka3a3['pieces']+$databanka3a4['pieces'] ;
                        echo $bank100;
                    ?>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $bank50 = 
                        $databanka4['pieces']+$databanka4a2['pieces']+$databanka4a3['pieces']+$databanka4a4['pieces'] ;
                        echo $bank50;
                    ?>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $bank20 = 
                        $databanka5['pieces']+$databanka5a2['pieces']+$databanka5a3['pieces']+$databanka5a4['pieces'] ;
                        echo $bank20;
                    ?>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $bank10 = 
                        $databanka6['pieces']+$databanka6a2['pieces']+$databanka6a3['pieces']+$databanka6a4['pieces'] ;
                        echo $bank10;
                    ?>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $coins = 
                        $databanka7['amount']+$databanka7a2['amount']+$databanka7a3['amount']+$databanka7a4['amount'] ;
                        echo $coins;
                    ?>
                    </td>
                    <td>
                ...
                <tr class="total-row">
                    ...
                    <td></td>
                    <td><?php $advance= $dataadvancea['advancea'];echo $advance; ?></td>
                </tr>
                <tr class="total-row">
                    <td>Total</td>
                    <td></td>
                    <td><strong><?php $total_pic=$subtotal+$totala+$advance+$bank500result;echo $total_pic;?></strong>
                    </td>
                </tr>
                <?php 
