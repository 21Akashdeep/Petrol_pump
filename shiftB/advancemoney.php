...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $advanceb = $_POST['advanceb'];
    

    $sql = "INSERT INTO advanceb (advanceb) 
            VALUES ('$advanceb')";

if ($conn->query($sql) === TRUE) {
    echo "<script>
            alert('Vendor added successfully!');
            window.location.href='mainshiftB.php'; // Redirect to dashboard or another page
          </script>";
} else {
    echo "<script>
    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="enter advance"name="advanceb">
            </div>
