...
$sql = "SELECT * FROM shiftb3 ORDER BY id DESC LIMIT 1";
$result = $conn->query($sql);

$latestData = $result->fetch_assoc(); // Fetch data as an associative array

// Fetch latest Shift C close reading
$sql_shiftC = "SELECT xp_close_reading FROM shifta3 ORDER BY id DESC LIMIT 1";
...
$sql_shiftC = "SELECT ms_close_reading FROM shifta3 ORDER BY id DESC LIMIT 1";
$result_shiftC = $conn->query($sql_shiftC);
$shiftC_data = $result_shiftC->fetch_assoc();
...
$sql_shiftA = "SELECT * FROM shiftb3 ORDER BY id DESC LIMIT 1";
...
<div class="container-box">
    ...
    <form action="shiftBm3DB.php" method="POST">
