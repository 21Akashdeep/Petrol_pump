...
$sql = "SELECT * FROM shiftb1 ORDER BY id DESC LIMIT 1";
...
$sql_shiftC = "SELECT xp_close_reading FROM shift ORDER BY id DESC LIMIT 1";
...
$sql_shiftC = "SELECT ms_close_reading FROM shift ORDER BY id DESC LIMIT 1";
$result_shiftC = $conn->query($sql_shiftC);
$shiftC_data = $result_shiftC->fetch_assoc();
...
$sql_shiftA = "SELECT * FROM shiftb1 ORDER BY id DESC LIMIT 1";
...
<div class="container-box">
    ...
    <form action="shiftBm1DB.php" method="POST">
