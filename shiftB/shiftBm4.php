...
$sql = "SELECT * FROM shiftb4 ORDER BY id DESC LIMIT 1";
$result = $conn->query($sql);

$latestData = $result->fetch_assoc(); // Fetch data as an associative array

// Fetch latest Shift C close reading
$sql_shiftC = "SELECT xg1_close_reading FROM shifta4 ORDER BY id DESC LIMIT 1";
...
$sql_shiftC = "SELECT xg2_close_reading FROM shifta4 ORDER BY id DESC LIMIT 1";
$result_shiftC = $conn->query($sql_shiftC);
$shiftC_data = $result_shiftC->fetch_assoc();
$shiftC_close_xg2_reading = isset($shiftC_data['xg2_close_reading']) ? $shiftC_data['xg2_close_reading'] : "";

$sql_shiftC = "SELECT ms1_close_reading FROM shifta4 ORDER BY id DESC LIMIT 1";
$result_shiftC = $conn->query($sql_shiftC);
$shiftC_data = $result_shiftC->fetch_assoc();
$shiftC_close_ms1_reading = isset($shiftC_data['ms1_close_reading']) ? $shiftC_data['ms1_close_reading'] : "";

$sql_shiftC = "SELECT ms2_close_reading FROM shifta4 ORDER BY id DESC LIMIT 1";
$result_shiftC = $conn->query($sql_shiftC);
$shiftC_data = $result_shiftC->fetch_assoc();
...
$sql_shiftA = "SELECT * FROM shiftb4 ORDER BY id DESC LIMIT 1";
...
<body>
    ...
    <div class="contai d-flex flex-container" style="margin: 20px;">
        ...
        <div class="contai-box">
            ...
            <form action="shiftBm4DB.php" method="POST">
