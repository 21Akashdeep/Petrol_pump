...
// Fetch Vendors Data
$sql = "SELECT * FROM shiftb4 LIMIT $limit OFFSET $offset";
$result = $conn->query($sql);

$sql2 = "SELECT * FROM shiftb4 LIMIT $limit OFFSET $offset";
$result2 = $conn->query($sql2);

$sql3 = "SELECT * FROM shiftb4 LIMIT $limit OFFSET $offset";
$result3 = $conn->query($sql3);

$sql4 = "SELECT * FROM shiftb4 LIMIT $limit OFFSET $offset";
$result4 = $conn->query($sql4);

// Total Records Count
$sql_count = "SELECT COUNT(*) AS total FROM shiftb4";
$count_result = $conn->query($sql_count);
$total_rows = $count_result->fetch_assoc()['total'];
$total_pages = ceil($total_rows / $limit);

// Total Records Count
$sql_count2 = "SELECT COUNT(*) AS total FROM shiftb4";
