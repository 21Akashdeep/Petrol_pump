...
$sql = "SELECT * FROM shiftb1 WHERE xp_close_reading IS NOT NULL ORDER BY shifta1_datetime DESC LIMIT 1";
$result = $conn->query($sql);
$data = $result->fetch_assoc();

$sql2 = "SELECT * FROM shiftb2 WHERE xp_close_reading IS NOT NULL ORDER BY shifta1_datetime DESC LIMIT 1";
...
$sql4 = "SELECT * FROM shiftb4 WHERE xg1_close_reading IS NOT NULL ORDER BY datetime DESC LIMIT 1";
...
$sqlbanka1 = "SELECT * FROM bankb2 ORDER BY id DESC LIMIT 1";
...
$sqlbanka2a2 = "SELECT pieces, amount FROM second_shiftb2 WHERE denomination = 200 ORDER BY date_time DESC LIMIT 1";
$resultbanka2a2 = $conn->query($sqlbanka2a2);
$databanka2a2 = $resultbanka2a2->fetch_assoc();

$sqlbanka2a3 = "SELECT pieces, amount FROM second_shiftb3 WHERE denomination = 200 ORDER BY date_time DESC LIMIT 1";
$resultbanka2a3 = $conn->query($sqlbanka2a3);
$databanka2a3 = $resultbanka2a3->fetch_assoc();

$sqlbanka2a4 = "SELECT pieces, amount FROM second_shiftb4 WHERE denomination = 200 ORDER BY date_time DESC LIMIT 1";
...
$sqlbanka3a2 = "SELECT pieces, amount FROM second_shiftb2 WHERE denomination = 100 ORDER BY date_time DESC LIMIT 1";
$resultbanka3a2 = $conn->query($sqlbanka3a2);
$databanka3a2 = $resultbanka3a2->fetch_assoc();

$sqlbanka3a3 = "SELECT pieces, amount FROM second_shiftb3 WHERE denomination = 100 ORDER BY date_time DESC LIMIT 1";
$resultbanka3a3 = $conn->query($sqlbanka3a3);
$databanka3a3 = $resultbanka3a3->fetch_assoc();

$sqlbanka3a4 = "SELECT pieces, amount FROM second_shiftb4 WHERE denomination = 100 ORDER BY date_time DESC LIMIT 1";
...
$sqlbanka4a2 = "SELECT pieces, amount FROM second_shiftb2 WHERE denomination = 50 ORDER BY date_time DESC LIMIT 1";
$resultbanka4a2 = $conn->query($sqlbanka4a2);
$databanka4a2 = $resultbanka4a2->fetch_assoc();

$sqlbanka4a3 = "SELECT pieces, amount FROM second_shiftb3 WHERE denomination = 50 ORDER BY date_time DESC LIMIT 1";
$resultbanka4a3 = $conn->query($sqlbanka4a3);
$databanka4a3 = $resultbanka4a3->fetch_assoc();

$sqlbanka4a4 = "SELECT pieces, amount FROM second_shiftb4 WHERE denomination = 50 ORDER BY date_time DESC LIMIT 1";
...
$sqlbanka5a2 = "SELECT pieces, amount FROM second_shiftb2 WHERE denomination = 20 ORDER BY date_time DESC LIMIT 1";
$resultbanka5a2 = $conn->query($sqlbanka5a2);
$databanka5a2 = $resultbanka5a2->fetch_assoc();

$sqlbanka5a3 = "SELECT pieces, amount FROM second_shiftb3 WHERE denomination = 20 ORDER BY date_time DESC LIMIT 1";
...
$sqlbanka5a4 = "SELECT pieces, amount FROM second_shiftb4 WHERE denomination = 20 ORDER BY date_time DESC LIMIT 1";
...
$sqlbanka6a2 = "SELECT pieces, amount FROM second_shiftb2 WHERE denomination = 10 ORDER BY date_time DESC LIMIT 1";
$resultbanka6a2 = $conn->query($sqlbanka6a2);
$databanka6a2 = $resultbanka6a2->fetch_assoc();

$sqlbanka6a3 = "SELECT pieces, amount FROM second_shiftb3 WHERE denomination = 10 ORDER BY date_time DESC LIMIT 1";
$resultbanka6a3 = $conn->query($sqlbanka6a3);
$databanka6a3 = $resultbanka6a3->fetch_assoc();

$sqlbanka6a4 = "SELECT pieces, amount FROM second_shiftb4 WHERE denomination = 10 ORDER BY date_time DESC LIMIT 1";
...
$sqlbanka7a2 = "SELECT pieces, amount FROM second_shiftb2 WHERE denomination = 'Coins' ORDER BY date_time DESC LIMIT 1";
$resultbanka7a2 = $conn->query($sqlbanka7a2);
$databanka7a2 = $resultbanka7a2->fetch_assoc();

$sqlbanka7a3 = "SELECT pieces, amount FROM second_shiftb3 WHERE denomination = 'Coins' ORDER BY date_time DESC LIMIT 1";
$resultbanka7a3 = $conn->query($sqlbanka7a3);
$databanka7a3 = $resultbanka7a3->fetch_assoc();

$sqlbanka7a4 = "SELECT pieces, amount FROM second_shiftb4 WHERE denomination = 'Coins' ORDER BY date_time DESC LIMIT 1";
...
// $sqlexp = "
//     SELECT expense_name, SUM(amount) AS total_amount FROM expenseb1 WHERE DATE(created_at) = '$today' GROUP BY expense_name
//     UNION ALL
//     SELECT expense_name, SUM(amount) AS total_amount FROM expenseb2 WHERE DATE(created_at) = '$today' GROUP BY expense_name
//     UNION ALL
//     SELECT expense_name, SUM(amount) AS total_amount FROM expenseb3 WHERE DATE(created_at) = '$today' GROUP BY expense_name
//     UNION ALL
//     SELECT expense_name, SUM(amount) AS total_amount FROM expenseb4 WHERE DATE(created_at) = '$today' GROUP BY expense_name
// ";
...
$stmt = $conn->prepare("
    ...
    FROM (
        SELECT expense_name, SUM(amount) AS total_amount FROM expenseb1 WHERE DATE(created_at) = ? GROUP BY expense_name
        UNION ALL
        SELECT expense_name, SUM(amount) AS total_amount FROM expenseb2 WHERE DATE(created_at) = ? GROUP BY expense_name
        UNION ALL
        SELECT expense_name, SUM(amount) AS total_amount FROM expenseb3 WHERE DATE(created_at) = ? GROUP BY expense_name
        UNION ALL
        SELECT expense_name, SUM(amount) AS total_amount FROM expenseb4 WHERE DATE(created_at) = ? GROUP BY expense_name
...
$sqladvancea = "SELECT * FROM advanceb ORDER BY id DESC LIMIT 1";
...
<body>
    ...
    $totalb = $bank200result + $bank100result + $bank50result + $bank20result + $bank10result + $coins;
    ...
    <table>
        ...
        <tr>
            ...
            <td></td>
            <?php
            $_SESSION['closing_balance_a'] = $totalb;
            ?>
            <td><?= $totalb ?></td>
    ...
    <div class="row">
        ...
        <div class="col-4">
            ...
            <table>
                ...
                <tr class="total-row">
                    ...
                    $total_opening_b = $closing_balance_a + $cashruning_sift_a;
                    // $_SESSION['total_opening_b'] = $total_opening_b;
                    ?>
                    <td><?php echo $total_opening_b ?></td>
        ...
        <div class="col-4">
            ...
            <table>
                ...
                <?php
                $advance = isset($dataadvancea['advanceb']) ? $dataadvancea['advanceb'] : 0;
                ...
                <tr class="total-row">
                    <td>Total</td>
                    <td></td>
                    <td><strong><?php $total_pic = $subtotal + $totalb + $advance + $bank500result;
