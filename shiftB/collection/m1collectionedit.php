...
$sql = "SELECT * FROM Collectionb1 WHERE id = $id";
$result = $conn->query($sql);
...
<body>
    <div class="container">
        <form method="POST" action="m1collectionupdate.php">
            ...
            <div class="row mb-3">
                ...
                <div class="col-4">
                    <select class="form-select" name="Employee_Name1" required>
                ...
                <div class="col-4">
                    <select class="form-select" name="Employee_Name2" required>
                        <option value="">Select Employee</option>
                        <?php foreach ($employees as $employee) { ?>
                        <option value="<?php echo $employee['company_name']; ?>"
