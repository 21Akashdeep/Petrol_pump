...
<body>
    ...
    displayTable($conn, "bankb1", ["id", "denomination", "pieces", "amount", "date_time"], ["ID", "Denomination", "Pieces", "Amount", "Date & Time"], $limit, $offset, $page);
    displayTable($conn, "second_shiftb1", ["id", "denomination", "pieces", "amount", "date_time"], ["ID", "Denomination", "Pieces", "Amount", "Date & Time"], $limit, $offset, $page);
    displayTable($conn, "transactionsb1", ["id", "total_amount", "date_time"], ["ID", "Total Amount", "Date & Time"], $limit, $offset, $page);
