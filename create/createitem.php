...
if ($conn->query($sql) === TRUE) {
    echo "<script>
            ...
            window.location.href='../list/itemlist.php'; // Redirect to dashboard or another page
          </script>";
} else {
    echo "<script>
    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter company name"name="item_name">
            </div>
