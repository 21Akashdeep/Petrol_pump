...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO vendors (company_name, gst_no, pan_no, contact_no, contact_person_no) 
            VALUES ('$company_name', '$gst_no', '$pan_no', '$contact_no', '$contact_person_no')";

    if ($conn->query($sql) === TRUE) {
        echo "<script>
            alert('Vendor added successfully!');
            window.location.href='../list/vendorlist.php'; // Redirect to dashboard or another page
          </script>";
    } else {
        echo "<script>
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" placeholder="Enter contact person's number"
