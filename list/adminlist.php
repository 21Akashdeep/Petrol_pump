...
// Fetch Vendors Data
$sql = "SELECT * FROM adminsignup LIMIT $limit OFFSET $offset";
$result = $conn->query($sql);

// Total Records Count
$sql_count = "SELECT COUNT(*) AS total FROM adminsignup";
    ...
    <div class="container container-content">
        ...
        <div class="bg-white p-4 shadow-sm rounded">
            <div class="btn-custom">
                ...
                <button type="button" class="btn btn-success mb-3 mx-3"onclick="window.location.href='../users/Admin signup.php'">Create New Admin</button>
            </div>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>{$row['password']}</td>
                                    <td>
                                <a href='../edit/adminedit.php?id=".$row['id']."' class='btn btn-warning btn-sm'>Edit</a>
