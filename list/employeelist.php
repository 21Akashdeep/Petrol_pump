...
<body>
        ...
        <div class="bg-white p-4 shadow-sm rounded">
            <div class="btn-custom">
                <button type="button" class="btn btn-success mb-3 mx-3"
                    onclick="window.location.href='../create/createemployee.php'">Create New Employee</button>
            </div>
    ...
    <footer>
        <p><strong>Copyright © 2025 <a href="https://pcats.co.in/" class="brand"  target="_blank">P-Cats, Jamshedpur</a>.</strong> All
            rights reserved.</p>
    </footer>
