...
// Fetch Vendors Data
$sql = "SELECT * FROM vendors LIMIT $limit OFFSET $offset";
$result = $conn->query($sql);

// Total Records Count
$sql_count = "SELECT COUNT(*) AS total FROM vendors";
    ...
    <div class="container container-content">
        ...
        <div class="bg-white p-4 shadow-sm rounded">
            <div class="btn-custom">
                <button type="button" class="btn btn-success mb-3"onclick="window.location.href='../create/createvender.php'">Create New Vendors</button>
            </div>
